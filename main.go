...
func main() {
	...
	newClient := Client{
		FIO:      "Ивлев Павел Николаевич", // укажите ФИО
		Login:    "Kunteynir",              // укажите логин
		Birthday: "19840601",               // укажите день рождения
		Email:    "oxxxymiron@govno.da",    // укажите почту
	}
	...
	newLogin := "Technique" // укажите новый логин
